...
# from gmt30_strat_1data import HeikinAshiStrategy
...
start_date = dt.datetime.strptime("2023-08-01 00:00:00", "%Y-%m-%d %H:%M:%S")
# end_date = dt.datetime.strptime("2023-09-01 00:00:00", "%Y-%m-%d %H:%M:%S")
...
if __name__ == '__main__':
    ...
    # Add the datafeed    
    cerebro.adddata(data_feed, name='data0')
    ...
    print (tabulate(trade_list, headers="keys", tablefmt="grid", missingval="?"))
    print()
    print()
    ...
    # asyncio.run(notifier.send_message(f"Optimization finished at {datetime.now(tz=kiev_tz)}\n"
